...
* **Diccionario de Variables:** * `pH` (Acidez/Alcalinidad)
...
### 👨‍💻 Sobre el Autor
**Jose Luis Garay Ramos** Estudiante de Estadística en la Universidad Nacional Agraria La Molina (UNALM), basado en Lima, Perú. Especializado en transformar datos complejos en análisis interpretables mediante metodologías estadísticas sólidas y programación en R/Python.  
